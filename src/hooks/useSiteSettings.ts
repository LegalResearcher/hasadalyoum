...
export const useCreateAdBanner = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => toast.error(error.message || "فشل إضافة الإعلان"),
  });
};
...
export const useUpdateAdBanner = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => toast.error(error.message || "فشل تحديث الإعلان"),
  });
};
...
export const useDeleteAdBanner = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => toast.error(error.message || "فشل حذف الإعلان"),
  });
};
