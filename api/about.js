...
<body>
  ...
  <div class="wrap">
    <h1>معين الناصر</h1>
    <p class="role">صاحب الامتياز ورئيس تحرير "${SITE_NAME}" - موقع إخباري يمني مستقل</p>
    <div class="body">
      <p>معين الناصر هو صاحب الامتياز ورئيس تحرير صحيفة ${SITE_NAME} الإلكترونية، المنبر الإعلامي اليمني الحر والمستقل الذي ينطلق من العاصمة صنعاء لتغطية الأحداث السياسية والاقتصادية والميدانية في اليمن والجنوب والعالم لحظة بلحظة.</p>
      <p>يتمتع معين الناصر بخلفية قانونية وشرعية، وهو مؤسس ومطوّر منصة الناصر القانونية (alnaseer.org) الموجهة لطلاب الشريعة والقانون بالجمهورية اليمنية.</p>
    </div>
  </div>
